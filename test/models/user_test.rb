...
class UserTest < ActiveSupport::TestCase
  def setup
  	@user = User.new(name: "Example User", email: "example@user.net", password: "foobar", password_confirmation: "foobar")
  end
  ...
  test "email addresses should be at least 6 characters" do
  	@user.password = @user.password_confirmation = "a" * 5
  	assert_not @user.valid?
  end

  test "email addresses should be in lowercase" do
  	mixed_case_email = "tEsT@TesTing.CoM"
